...
class ReservatieController extends AbstractController
{
    ...
    /**
     * @Route("/dag", name="reservatie_indexdag", methods={"GET"})
     */
    public function indexdag(ReservatieRepository $reservatieRepository): Response
    {

        $datum = new \DateTime("now");

        return $this->render('reservatie/index.html.twig', [
            'reservaties' => $reservatieRepository->findreserveringendag($datum),
        ]);
    }
